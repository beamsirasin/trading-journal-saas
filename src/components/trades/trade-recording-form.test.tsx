...
/*
  ...
  so the form receives it â€” which is why these render in a mode rather than
  clicking into one.
*/
 ...
 * they own on EVERY click â€” including a click on the segment that is already
...
describe('TradeRecordingForm — Phase 15G.5D recording UX', () => {
  ...
  it('says what choosing Price costs, at the moment it is chosen', () => {
    ...
    // consequence is stated here â€” not at save, by which time the choice has
