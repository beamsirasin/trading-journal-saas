...
const SCREENS: readonly Screen[] = [
  ...
  },
  {
    ...
    note: 'Nothing pre-filled and no timestamp defaulted to now — a historical form has to hold "I don’t remember".',
  ...
  },
  {
    ...
    note: 'One column, stacked timestamps, and Profit / Loss / Break-even rather than a sign toggle to discover.',
    path: '/prototype/log-trade/after-trade',
    width: 390,
    height: 780,
  },
  {
    id: 'fully-closed-filled',
    number: '9b',
    title: 'Fully closed · answered',
    note: 'A recalled plan, a final result, and both R values derived from them. Nothing stores an R of its own.',
    path: '/prototype/log-trade/after-trade?filled=1',
    width: 1440,
    height: 1200,
  },
  {
    id: 'exits',
    number: '10',
    title: 'Exit details · supporting, not authoritative',
    note: 'The final +400.00 stays the result while the recorded legs total +80.00. The difference is unrecorded history, never a fabricated leg.',
    path: '/prototype/log-trade/after-trade?filled=1&exits=1',
    width: 1120,
    height: 1250,
  },
  {
    id: 'adopt-offer',
    number: '10c',
    title: 'Exit details · a reconstruction offered as the result',
    note: 'Complete, every leg priced, and no whole-trade figure ever known. The result stays unknown until the offer is taken.',
    path: '/prototype/log-trade/after-trade?reconstruct=1',
    width: 1120,
    height: 1250,
  },
  {
    id: 'adopt-mobile',
    number: '10d',
    title: 'Exit details · the offer on a phone',
    note: 'The adoption action is a real button and names the figure it would install. Final result still leads.',
    path: '/prototype/log-trade/after-trade?reconstruct=1',
    width: 390,
    height: 780,
  },
  ...
  },
  {
    ...
    path: '/prototype/log-trade/after-trade?filled=1&exits=1&edit=e2',
    width: 1120,
    height: 1350,
  },
];
