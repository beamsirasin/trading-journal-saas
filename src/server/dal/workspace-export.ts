    ...
    async (tx) => {
      ...
      const tradeRows = await tx
        .select({
          ...
          exitHistoryCompleteness: trades.exitHistoryCompleteness,
          finalPnlSource: trades.finalPnlSource,
          ...
          planAdherence: trades.planAdherence,
      ...
      const exitRows = await tx
        .select({
          ...
          exitScope: tradeExits.exitScope,
