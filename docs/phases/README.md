...
Read [`../../CLAUDE.md`](../../CLAUDE.md) first, then any approved Product Contract for the domain in [`../product-contracts/`](../product-contracts/), then — for user-facing work — [`../UX_RULES.md`](../UX_RULES.md) and the visual system ([`../design-system.md`](../design-system.md)), then the active phase document. Phase documents are historical records: where one disagrees with an approved Product Contract, the UX Rules or a newer canonical document, the newer authority wins (see [`../product-contracts/README.md`](../product-contracts/README.md)). Do not implement work belonging to a later phase.
