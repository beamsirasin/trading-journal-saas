...
Phases 00, 00b, 01, 01.1, 02, 02.1, implementation Phase 3A–3C, [Phase 04 — Billing & Checkout](PHASE-04-billing.md) (including the 04H-A production payment-provider guard), and [Phase 05 — Onboarding & Trading Accounts](PHASE-05-onboarding-accounts.md) are complete. [Phase 06 — Strategies & Versions](PHASE-06-strategies.md) is the next implementation phase.
